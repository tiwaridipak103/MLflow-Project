...
for col in numerical_cols:
    dataset[col] = pd.to_numeric(dataset[col], errors='coerce')  # Convert to numeric, invalid values will become NaN
...
def mlflow_logging(model, X, y, name):
     ...
     with mlflow.start_run(run_name=name) as run:
        ...
        # Create an input example using part of the test data
        ...
        mlflow.sklearn.log_model(model, name, input_example=input_example, signature=signature)
